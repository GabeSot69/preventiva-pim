...
router.post('/', autorizar(PerfilChave.ADMIN, PerfilChave.TECNICO, PerfilChave.SUPERVISOR, PerfilChave.GESTOR), validateBody(CriarExecucaoManutencaoSchema), controller.criar);
router.get('/', controller.listar);
router.get('/:id', controller.obterPorId);
router.put('/:id', autorizar(PerfilChave.ADMIN, PerfilChave.TECNICO, PerfilChave.SUPERVISOR, PerfilChave.GESTOR), validateBody(AtualizarExecucaoManutencaoSchema), controller.atualizar);
