...
router.post('/', autorizar(PerfilChave.SUPERVISOR, PerfilChave.GESTOR), validateBody(CriarEquipamentoSchema), controller.criar);
router.get('/', controller.listar);
router.get('/:id', controller.obterPorId);
router.put('/:id', autorizar(PerfilChave.SUPERVISOR, PerfilChave.GESTOR), validateBody(AtualizarEquipamentoSchema), controller.atualizar);
